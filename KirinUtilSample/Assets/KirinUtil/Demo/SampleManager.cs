...
public class SampleManager : MonoBehaviour {
    ...
    private void HttpSuccess(UnityWebRequest request) {
        print("---------------HttpSuccess: " + request.downloadHandler.text);
    }

    private void HttpError(UnityWebRequest request) {
        print("---------------HttpError: " + request.downloadHandler.text);
    }

    public void FinishMovie(int num) {
        print("EndPlayImage");
    }
